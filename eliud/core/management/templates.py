...
from eliud.core.management.base import BaseCommand, CommandError
from eliud.core.management.utils import (
    find_formatters,
    handle_extensions,
    run_formatters,
)
from eliud.template import Context, Engine
from eliud.utils import archive
from eliud.utils.http import parse_header_parameters
...
class TemplateCommand(BaseCommand):
    ...
    def handle(self, app_or_project, name, target=None, **options):
        ...
        context = Context(
            {
                **options,
                ...
                "eliud_version": eliud.__version__,
            },
            autoescape=False,
        )
        ...
        for root, dirs, files in os.walk(template_dir):
            ...
            for filename in files:
                ...
                # accidentally render Eliud templates files
    ...
    def handle_template(self, template, subdir):
        ...
        Use eliud.__path__[0] as the default because the Eliud install
        directory isn't known.
        """
        if template is None:
            return os.path.join(eliud.__path__[0], "conf", subdir)
        else:
    ...
    def download(self, url):
        ...
        prefix = "eliud_%s_template_" % self.app_or_project
        ...
        opener = build_opener()
        opener.addheaders = [("User-Agent", f"Eliud/{eliud.__version__}")]
        try:
