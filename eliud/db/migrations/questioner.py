...
from eliud.core.management.base import OutputWrapper
...
class InteractiveMigrationQuestioner(MigrationQuestioner):
    ...
    def _ask_default(self, default=""):
        ...
        self.prompt_output.write(
            "The datetime and eliud.utils.timezone modules are available, so "
        ...
        if not self.dry_run:
            ...
            choice = self._choice_input(
                ...
                [
                    ...
                    f"described here: "
                    f"https://docs.eliudproject.com/en/{version}/howto/"
