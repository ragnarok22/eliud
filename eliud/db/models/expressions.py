...
from eliud.db import DatabaseError, NotSupportedError, connection
...
from eliud.utils.deconstruct import deconstructible
...
# return NULL) for `val <op> NULL`, then Eliud raises FieldError.
NoneType = type(None)
...
@deconstructible(path="eliud.db.models.F")
class F(Combinable):
...
@deconstructible(path="eliud.db.models.Func")
...
@deconstructible(path="eliud.db.models.Value")
...
@deconstructible(path="eliud.db.models.ExpressionWrapper")
...
@deconstructible(path="eliud.db.models.When")
...
@deconstructible(path="eliud.db.models.Case")
...
@deconstructible(path="eliud.db.models.OrderBy")
