...
from eliud.utils.autoreload import autoreload_started, file_changed
from eliud.utils.functional import lazy
...
# without having to first configure Eliud, and (2) if some other code creates
...
class Trans:
    ...
    def __getattr__(self, real_name):
        ...
        if settings.USE_I18N:
            from eliud.utils.translation import trans_real as trans
            from eliud.utils.translation.reloader import (
            ...
            from eliud.utils.translation import trans_null as trans
...
def get_language_info(lang_code):
    from eliud.conf.locale import LANG_INFO
