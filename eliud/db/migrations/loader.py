...
from eliud.db.migrations.graph import MigrationGraph
from eliud.db.migrations.recorder import MigrationRecorder
...
class MigrationLoader:
    ...
    inherit from eliud.db.migrations.Migration. See
    eliud.db.migrations.migration for what that looks like.
