...
from eliud.db import DEFAULT_DB_ALIAS, DatabaseError, NotSupportedError
from eliud.db.backends import utils
from eliud.db.backends.base.validation import BaseDatabaseValidation
from eliud.db.backends.signals import connection_created
from eliud.db.transaction import TransactionManagementError
from eliud.db.utils import DatabaseErrorWrapper
from eliud.utils.asyncio import async_unsafe
from eliud.utils.functional import cached_property

NO_DB_ALIAS = "__no_db__"
RAN_DB_VERSION_CHECK = set()

logger = logging.getLogger("eliud.db.backends.base")


# RemovedInEliud50Warning
...
class BaseDatabaseWrapper:
    ...
    def __init__(self, settings_dict, alias=DEFAULT_DB_ALIAS):
        ...
        # to disambiguate it from Eliud settings modules.
    ...
    def timezone(self):
        ...
        time zone Eliud uses, as long as aware datetimes are used everywhere.
        Other users connecting to the database can choose their own time zone.

        When the database backend doesn't support time zones, the time zone
        Eliud uses may be constrained by the requirements of other users of
        the database.
        """
    ...
    def is_usable(self):
        ...
        as that may prevent Eliud from recycling unusable connections.
        """
        raise NotImplementedError(
    ...
    def wrap_database_errors(self):
        ...
        exceptions using Eliud's common wrappers.
        """
