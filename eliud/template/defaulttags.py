...
from eliud.utils.html import conditional_escape, escape, format_html
from eliud.utils.lorem_ipsum import paragraphs, words
from eliud.utils.safestring import mark_safe
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from eliud.utils.html import strip_spaces_between_tags
...
class URLNode(Node):
    ...
    def render(self, context):
        from eliud.urls import NoReverseMatch, reverse
...
def load(parser, token):
    ...
    ``eliud/templatetags/news/photos.py``::
