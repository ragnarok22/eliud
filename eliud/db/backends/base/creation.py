...
from eliud.core import serializers
from eliud.db import router
from eliud.db.transaction import atomic
...
class BaseDatabaseCreation:
    ...
    def create_test_db(
        ...
        """
        # Don't import eliud.core.management if it isn't needed.
        from eliud.core.management import call_command
    ...
    def mark_expected_failures_and_skips(self):
        """
        Mark tests in Eliud's test suite which are expected failures on this
        database and test which should be skipped on this database.
        """
        # Only load unittest if we're actually testing.
        from unittest import expectedFailure, skip

        for test_name in self.connection.features.eliud_test_expected_failures:
        ...
        for reason, tests in self.connection.features.eliud_test_skips.items():
    ...
    def setup_worker_connection(self, _worker_id):
        ...
        # reflected in eliud.db.connections. If the following line assigned
