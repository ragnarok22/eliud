...
from eliud.db import IntegrityError, connections, models, transaction
from eliud.db.models import query_utils, signals, sql
...
def SET(value):
    ...
    set_on_delete.deconstruct = lambda: ("eliud.db.models.SET", (value,), {})
