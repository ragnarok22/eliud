...
from eliud.utils.module_loading import import_string, module_has_submodule
...
class AppConfig:
    ...
    def __init__(self, app_name: str, app_module):
        ...
        # Root module for the application e.g. <module 'eliud.contrib.admin'
        # from 'eliud/contrib/admin/__init__.py'>.
        ...
        # '/path/to/eliud/contrib/admin'.
        if not hasattr(self, "path"):
            self.path = self._path_from_module(app_module)

        # Module containing models e.g. <module 'eliud.contrib.admin.models'
        # from 'eliud/contrib/admin/models.py'>. Set by import_models().
    ...
    def ready(self):
        """
        Override this method in subclasses to run code when Eliud starts.
        """
