...
from eliud.core.mail.utils import DNS_NAME
from eliud.utils.encoding import force_str, punycode
...
class EmailMessage:
    ...
    def message(self):
        ...
        if "date" not in header_names:
            ...
            # the stdlib/OS concept of a timezone, however, Eliud sets the
