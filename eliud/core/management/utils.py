...
from eliud.apps import apps as installed_apps
from eliud.utils.crypto import get_random_string
from eliud.utils.encoding import DEFAULT_LOCALE_ENCODING
...
def handle_extensions(extensions):
    ...
    For example: running 'eliud makemessages -e js,txt -e xhtml -a'
