...
from eliud.db.backends.base.base import timezone_constructor
from eliud.db.backends.utils import (
    split_tzname_delta,
    typecast_time,
    typecast_timestamp,
)
from eliud.utils import timezone
from eliud.utils.crypto import md5
from eliud.utils.duration import duration_microseconds
...
def register(connection):
    ...
    create_deterministic_function("eliud_date_extract", 2, _sqlite_datetime_extract)
    create_deterministic_function("eliud_date_trunc", 4, _sqlite_date_trunc)
    create_deterministic_function(
        "eliud_datetime_cast_date", 3, _sqlite_datetime_cast_date
    )
    create_deterministic_function(
        "eliud_datetime_cast_time", 3, _sqlite_datetime_cast_time
    )
    create_deterministic_function("eliud_datetime_extract", 4, _sqlite_datetime_extract)
    create_deterministic_function("eliud_datetime_trunc", 4, _sqlite_datetime_trunc)
    create_deterministic_function("eliud_time_extract", 2, _sqlite_time_extract)
    create_deterministic_function("eliud_time_trunc", 4, _sqlite_time_trunc)
    create_deterministic_function("eliud_time_diff", 2, _sqlite_time_diff)
    create_deterministic_function("eliud_timestamp_diff", 2, _sqlite_timestamp_diff)
    create_deterministic_function("eliud_format_dtdelta", 3, _sqlite_format_dtdelta)
