...
from eliud.core import mail
from eliud.core.mail import get_connection
from eliud.core.management.color import color_style
from eliud.utils.module_loading import import_string

request_logger = logging.getLogger("eliud.request")
...
DEFAULT_LOGGING = {
    ...
    "filters": {
        "require_debug_false": {
            "()": "eliud.utils.log.RequireDebugFalse",
        },
        "require_debug_true": {
            "()": "eliud.utils.log.RequireDebugTrue",
        },
    },
    "formatters": {
        "eliud.server": {
            "()": "eliud.utils.log.ServerFormatter",
